...
echo $_SESSION["user_id"];
      ...
      $exe= array(":post_title"=>$title,":discription"=>$description,":prize"=>$price,":tag"=>"null",":specification"=>$specification,":cat_id"=>$cat_id,":post_date"=>$date,":loc_id"=>0,":user_id"=>$_SESSION['user_id'],":city_id"=>$city,":photo_url"=>$attachment);
	  print_r($exe);
			...
			<section class="post-form-section">
				...
				<form method="post" action="" enctype="multipart/form-data">
					<div class="from-box">
						...
						<select name="sub_cat_id" class="each-field">
						...
						<select name="specification" class="each-field spl">
